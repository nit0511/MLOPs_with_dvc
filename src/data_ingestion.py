...
def load_params(params_path: str) ->dict:
    ...
    try:
        ...
        logger.debug('Parameters retrieved form %s', params_path)
        return params
...
def preporcess(df: pd.DataFrame) -> pd.DataFrame:
    """Preprocess the data."""
    try:
...
def save_data(train_data: pd.DataFrame, test_data:pd.DataFrame, data_path: str) -> None:
    """Save teh train and test datasets"""
    try:
